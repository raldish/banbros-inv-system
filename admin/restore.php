...
$query = "INSERT INTO client (company_code, assigned_to, firstname, middlename, surname, location_n, model_description, serial_number, quantity, con_dition, added_at)
          SELECT company_code, assigned_to, firstname, middlename, surname, location_n, model_description, serial_number, quantity, con_dition, added_at
          FROM tbl_archive
          WHERE ID = $id";
